...
class DatasetWebQSP(Dataset):
    def __init__(self, data, entities, entity2idx, transformer_name):
        ...
        self.tokenizer = get_tokenizer(transformer_name) #helper func
    ...
    def __getitem__(self, index):
        ...
        encoded_question = tokenize_question(question_text)
        question_tokenized=encoded_question['input_ids']
